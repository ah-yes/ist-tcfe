...
\begin{equation}
\frac{\tilde{V_{out}}}{\tilde{V_{o}}} = \bigg(1+\frac{R_4}{R_3}\bigg)\frac{1}{R_2j\omega C_2 + 1}\frac{1}{R_2j\omega C_2 + 1}
\end{equation}

Hence, combining the two we get 
\begin{equation}
\text{Gain} = \frac{\tilde{V_{out}}}{\tilde{V_{in}}} =\frac{j\omega C_1R_1}{R_1j\omega C_1 + 1}\bigg(1+\frac{R_4}{R_3}\bigg)\frac{1}{R_2j\omega C_2 + 1}\frac{1}{R_2j\omega C_2 + 1}
\label{eq:Gain}
\end{equation}
