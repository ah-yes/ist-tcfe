...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
\includegraphics[width=\textwidth]{../mat/venvelope.png}
\label{fig:venvelope}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.45\textwidth}
...
I = I_s\bigg(e^{\frac{V}{\eta V_T}} - 1\bigg)
...
V_C - R_{\phi}I_s\bigg(e^{\frac{V_{out}}{6\eta V_T}} - 1\bigg) - V_{out} = 0
...
The ripple as been calculated as
...
\begin{equation}
improvement = \frac{ripple(Regulator)}{ripple(Envelope)\times 100}
\end{equation}

We obtained
\input{../mat/Results.tex}

Lastly, we ploted $V_{out} - 12V$
